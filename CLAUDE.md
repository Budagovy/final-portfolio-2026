...
<SplashScreen data={splash} id="top">
  <HeroPlaceholder data={hero} />   // swap for the real hero
</SplashScreen>
```
...
`content/hero.json`, the page title, and `src/app/icon.svg` are placeholders.
The greeting ("Nice to meet you") was carried over from the portfolio.
